            ...
            {rangeFields.map((rangeField) => (
              <div key={rangeField.id}>
                <TextField
                  ...
                  onChange={(event) => handlerChangeInput(rangeField.id, event)}
                />
                &nbsp;&nbsp;
                <TextField
                  name="rangefrom"
          ...
          <CardContent style={{ backgroundColor: '#deebff' }}>
            <Row>
              ...
              <Col>
                <input
                  type="text"
                  style={{ display: mvp ? 'block ' : 'none' }}
                  placeholder="Numder of Prizes"
                />
              </Col>
              <Col>
                {' '}
              ...
              <Col>
                <input
                  ...
                  name="mvp"
                />
                <label style={{ display: mvp ? 'block ' : 'none' }} htmlFor="">
                  {' '}
                  Minimum
                </label>
              </Col>
              <Col>
                <input
                  ...
                  value="range"
                />{' '}
                <label style={{ display: mvp ? 'block ' : 'none' }}>
                  range
                </label>
              </Col>
              <Col>
            ...
            <Row>
              ...
              <Col>
                <input
                  type="text"
                  style={{ display: A_kill ? 'block ' : 'none' }}
                  placeholder="Numder of Prizes"
                />
              </Col>
              <Col>
              ...
              <Col>
                <input
                  ...
                  value="range"
                />{' '}
                <label style={{ display: A_kill ? 'block ' : 'none' }}>
                  range
                </label>
              </Col>
              <Col>
            ...
            <Row>
              ...
              <Col>
                <p>Top_Assaulter(Damage)</p>
              </Col>
              <Col>
                <input
                  type="text"
                  style={{ display: A_damage ? 'block ' : 'none' }}
                  placeholder="Numder of Prizes"
                />
              </Col>
              <Col>
              ...
              <Col>
                <input
                  ...
                  value="range"
                />{' '}
                <label style={{ display: A_damage ? 'block ' : 'none' }}>
                  range
                </label>
              </Col>
              <Col>
            ...
            <Row>
              ...
              <Col>
                <input
                  type="text"
                  style={{ display: Reviver ? 'block ' : 'none' }}
                  placeholder="Numder of Prizes"
                />
              </Col>
              <Col>
              ...
              <Col>
                <input
                  ...
                  value="range"
                />{' '}
                <label style={{ display: Reviver ? 'block ' : 'none' }}>
                  range
                </label>
              </Col>
              <Col>
            ...
            <Row>
              ...
              <Col>
                <input
                  type="text"
                  style={{ display: greanadier ? 'block ' : 'none' }}
                  placeholder="Numder of Prizes"
                />
              </Col>
              <Col>
              ...
              <Col>
                <input
                  ...
                  value="range"
                />{' '}
                <label style={{ display: greanadier ? 'block ' : 'none' }}>
                  range
                </label>
              </Col>
              <Col>
            ...
            <Row>
              ...
              <Col>
                <input
                  type="text"
                  style={{ display: clutcher ? 'block ' : 'none' }}
                  placeholder="Numder of Prizes"
                />
              </Col>
              <Col>
              ...
              <Col>
                <input
                  ...
                  value="range"
                />{' '}
                <label style={{ display: clutcher ? 'block ' : 'none' }}>
                  range
                </label>
              </Col>
              <Col>
            ...
            <Row>
              ...
              <Col>
                <input
                  ...
                  value="range"
                />{' '}
                <label style={{ display: sniper ? 'block ' : 'none' }}>
                  range
                </label>{' '}
              </Col>
              <Col>
